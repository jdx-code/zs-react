        ...
        <div className="w-full bg-white py-8 px-4">
            <div className="max-w-[1240px] mx-auto grid text-[#2c0f37] md:grid-cols-2">
                ...
                <div className="flex flex-col justify-center items-center text-center md:items-start md:text-left">
                    <h1 className="text-lg font-bold py-2 sm:text-2xl md:text-4xl">Why Choose Us ?</h1>
                    ...
                    <button className="w-[115px] bg-gray-100 text-[#2c0f37] border-2 border-[#2c0f37] font-medium text-sm px-2 py-3 mx-auto md:mx-0 my-4 rounded-md sm:w-[145px] md:w-[160px] sm:text-lg md:text-xl hover:bg-[#2c0f37] hover:text-gray-100">View projects</button>
                </div>
            </div>            
        </div>
    )
