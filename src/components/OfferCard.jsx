...
const OfferCard = (props) => {
    return (
        <div className="w-full max-w-[85%] text-center font-black flex flex-col sm:flex-row lg:flex-col bg-pink-100 border-2 border-pink-200 rounded-lg px-10 py-8 shadow-xl md:max-w-[99%] lg:col-span-2 hover:border-[#3b1949] hover:scale-105 hover:shadow-2xl duration-300">
