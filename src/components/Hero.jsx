    ...
    return(
        <div className="text-green-100 h-screen">
            <div className="max-w-[800px] w-full py-24 md:py-32 mx-auto text-center flex flex-col justify-center">                                
                ...
                <button className="w-[115px] bg-gray-100 text-[#2c0f37] font-black border-[1px] border-[white] text-sm px-2 py-2 mx-auto my-2 rounded-md sm:w-[145px] md:w-[160px] sm:text-lg md:text-xl hover:bg-[#2c0f37] hover:text-gray-100 hover:transition duration-150">
                    <NavLink to="/about">Know us more</NavLink>
                </button>
            </div>                                    
        </div>
    )
