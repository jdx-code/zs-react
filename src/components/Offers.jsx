...
const Offers = () => {
    return (
        <div className="flex flex-col justify-center items-center bg-white text-gray-800">
            <h1 className="text-2xl text-center">What we offer ?</h1>
            <div className="w-full max-w-[1100px] flex flex-col justify-center items-center m-8 md:flex-row md:flex-wrap border-2 border-yellow-300">
                <div className="w-64 h-[300px] border-2 border-gray-700 rounded-lg m-12 px-12 py-8 flex flex-col justify-center items-center">
